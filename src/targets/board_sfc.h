...
// debug only
#define HAS_USB
#define HAS_AQ_TELEMETRY

// test wmm
#define WMM_STACK_SIZE    512
#define WMM_TASK_PRIORITY 200

#define STM32F4_DEFECTS  // workaround for exti issues
...
#define SDIO_DETECT_PIN_SOURCE  EXTI_PinSource8
#define SDIO_DETECT_IRQ         EXTI9_5_IRQn
#define SDIO_DETECT_HANDLER     EXTI9_5_IRQHandler
#define SDIO_DETECT_EXTI_LINE   EXTI_Line8
...
/*
  ...
  PB7 - T4C2
 */
#define PWM_IRQ_TIM12_CH1 0
#define PWM_IRQ_TIM12_CH2 1
#define PWM_IRQ_TIM3_CH4 2
#define PWM_IRQ_TIM3_CH3 3
#define PWM_IRQ_TIM3_CH1 4
#define PWM_IRQ_TIM3_CH2 5
#define PWM_IRQ_TIM4_CH1 6
#define PWM_IRQ_TIM4_CH2 7
#define PWM_IRQ_TIM9_CH2 8

#define COMM_PORT1 USART1
#define RC1_UART   USART2
#define RC2_UART   UART4
#define GPS_USART  USART3

#define GPS_LED_PORT          GPIOB
#define GPS_LED_PIN           GPIO_Pin_3
#define SUPERVISOR_READY_PORT GPIOB
#define SUPERVISOR_READY_PIN  GPIO_Pin_4
#define SUPERVISOR_DEBUG_PORT GPIOB
#define SUPERVISOR_DEBUG_PIN  GPIO_Pin_5

#define RCC_EN1_PORT GPIOA
#define RCC_EN1_PIN  GPIO_Pin_2
#define RCC_EN2_PORT GPIOA
#define RCC_EN2_PIN  GPIO_Pin_0

// workaround for radio.c
#define RADIO_RC1_SELECT_PORT RCC_EN1_PORT
#define RADIO_RC1_SELECT_PIN  RCC_EN1_PIN
#define RADIO_RC2_SELECT_PORT RCC_EN2_PORT
#define RADIO_RC2_SELECT_PIN  RCC_EN2_PIN
...
#define I2C_I2C1_SDA_AF     GPIO_AF_I2C1
#define I2C_I2C1_SCL_PORT   GPIOB
#define I2C_I2C1_SCL_PIN    GPIO_Pin_6
#define I2C_I2C1_SCL_SOURCE GPIO_PinSource6
#define I2C_I2C1_SCL_AF     GPIO_AF_I2C1

#define I2C_I2C1_DMA_CLOCK        RCC_AHB1Periph_DMA1
#define I2C_I2C1_DMA_RX           DMA1_Stream0
#define I2C_I2C1_DMA_RX_CHANNEL   DMA_Channel_1
#define I2C_I2C1_DMA_RX_FLAGS    (DMA_FLAG_FEIF0 | DMA_FLAG_DMEIF0 | DMA_FLAG_TEIF0 | DMA_FLAG_HTIF0 | DMA_FLAG_TCIF0)
#define I2C_I2C1_DMA_RX_IRQ       DMA1_Stream0_IRQn
#define I2C_I2C1_DMA_RX_HANDLER   DMA1_Stream0_IRQHandler
#define I2C_I2C1_DMA_RX_FLAG_TCIF DMA_FLAG_TCIF0
#define I2C_I2C1_DMA_TX           DMA1_Stream7
#define I2C_I2C1_DMA_TX_CHANNEL   DMA_Channel_1
#define I2C_I2C1_DMA_TX_FLAGS    (DMA_FLAG_FEIF7 | DMA_FLAG_DMEIF7 | DMA_FLAG_TEIF7 | DMA_FLAG_HTIF7 | DMA_FLAG_TCIF7)
#define I2C_I2C1_DMA_TX_IRQ       DMA1_Stream7_IRQn
#define I2C_I2C1_DMA_TX_HANDLER   DMA1_Stream7_IRQHandler
#define I2C_I2C1_DMA_TX_FLAG_TCIF DMA_FLAG_TCIF7
...
#define ICM20689
#define DIMU_HAVE_MAG3110
#define DIMU_HAVE_MS5611

#define MPU6000_ACC_SCALE   8  // g (2, 4, 8)
#define MPU6000_GYO_SCALE 500  // deg/s (250, 500, 1000, 2000)
...
#define DIMU_ORIENT_MAG_X     (+in[1])
#define DIMU_ORIENT_MAG_Y     (-in[0])
#define DIMU_ORIENT_MAG_Z     (-in[2])

#define DIMU_EEPROM_I2C            I2C1
#define DIMU_EEPROM_I2C_ADDR       0xA0 /* 0b10100000 */

#define DIMU_MAG3110_I2C           I2C1
#define DIMU_MAG3110_I2C_ADDR      0x1C /* 0x0E << 1 */
#define DIMU_MAG3110_INT_PORT      GPIOA
#define DIMU_MAG3110_INT_PIN       GPIO_Pin_15
#define DIMU_MAG3110_INT_EXTI_PORT EXTI_PortSourceGPIOA
#define DIMU_MAG3110_INT_EXTI_PIN  EXTI_PinSource15
#define DIMU_MAG3110_INT_EXTI_LINE EXTI_Line15
#define DIMU_MAG3110_INT_EXTI_IRQ  EXTI15_10_IRQn
#define DIMU_MAG3110_INT_ISR       EXTI15_10_IRQHandler

#define DIMU_MS5611_SPI     SPI1
#define DIMU_MS5611_CS_PORT GPIOC
#define DIMU_MS5611_CS_PIN  GPIO_Pin_5

#define DIMU_MPU6000_SPI           SPI1
#define DIMU_MPU6000_CS_PORT       GPIOC
#define DIMU_MPU6000_CS_PIN        GPIO_Pin_4
#define DIMU_MPU6000_INT_PORT      GPIOC
#define DIMU_MPU6000_INT_PIN       GPIO_Pin_13
#define DIMU_MPU6000_INT_EXTI_PORT EXTI_PortSourceGPIOC
#define DIMU_MPU6000_INT_EXTI_PIN  EXTI_PinSource13
#define DIMU_MPU6000_INT_EXTI_LINE EXTI_Line13
#define DIMU_MPU6000_INT_EXTI_IRQ  EXTI15_10_IRQn
#define DIMU_MPU6000_INT_ISR       EXTI15_10_IRQHandler
...
#define SERIAL_UART2_RX_TC_FLAG DMA_FLAG_TCIF1
#define SERIAL_UART2_RX_HT_FLAG DMA_FLAG_HTIF1
#define SERIAL_UART2_RX_TE_FLAG DMA_FLAG_TEIF1
#define SERIAL_UART2_RX_DM_FLAG DMA_FLAG_DMEIF1
#define SERIAL_UART2_RX_FE_FLAG DMA_FLAG_FEIF1
...
#define ANALOG_CHANNEL_EXT_VOLT ADC_Channel_12
#define ANALOG_CHANNEL_SPARE4   ADC_Channel_13
//#define ANALOG_CHANNEL_SPARE5   ADC_Channel_14
...
#define UKF_VEL_DELAY   -1.0182e+05 // -101820.0000000000 0.000000500000 +0.000000000000000
