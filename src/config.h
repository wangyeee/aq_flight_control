...
#define CONFIG_BIN_MAGIC 0x1927
...
#define CONFIG_BINARY_PARAM_SIZE sizeof(configBinary_t)
...
extern void configGetBinaryParam(configBinary_t* cfg, uint16_t n);
extern int configParseBinaryParams(uint8_t* fileBuf, int size);
