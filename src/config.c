...
void configLoadDefault(void) {
    ...
    p[CTRL_DBAND_SWTCH] = DEFAULT_CTRL_DBAND_SWTCH;
    ...
    p[NAV_CTRL_HOM_SET] = DEFAULT_NAV_CTRL_HOM_SET;
    ...
    p[GMBL_CTRL_TILT] = DEFAULT_GMBL_CTRL_TILT;
    p[GMBL_TILT_PORT] = DEFAULT_GMBL_TILT_PORT;
    p[GMBL_TRIG_PORT] = DEFAULT_GMBL_TRIG_PORT;
    p[GMBL_CTRL_TRG_ON] = DEFAULT_GMBL_CTRL_TRG_ON;
